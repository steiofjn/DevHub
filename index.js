...
const GUILD_ID = "1371813199606714508";


// ===== VERIFY SYSTEM =====
const UNVERIFIED_ROLE = "PUT UNVERIFIED ROLE ID HERE";
const VERIFIED_ROLES = [
  "PUT VERIFIED ROLE ID HERE",
  "PUT VERIFIED ROLE ID HERE"
];
const VERIFY_CHANNEL_ID = "PUT VERIFY CHANNEL ID HERE";

// ===== CHANNELS =====
const FULL_LOG_CHANNEL_ID = "PUT FULL LOG CHANNEL ID HERE";
const BAN_LOG_CHANNEL = "PUT BAN LOG CHANNEL ID HERE";
const INVITE_LOG_CHANNEL = "PUT INVITE LOG CHANNEL ID HERE";
const MIN_ACCOUNT_AGE_DAYS = 3;

// ===== ROLES =====
const MOD_ROLE_ID = [
  "1371813199829012546",
  "PUT MOD ROLE ID HERE",
  "PUT MOD ROLE ID HERE",
  "PUT MOD ROLE ID HERE"
];
